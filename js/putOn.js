...
// 		<div class="c-randomdata__navbar" style="background-color: #111; width: 100%; height: 1em; min-width: 1em; color: white; text-align: right; font-family: monospace;">
// 			<span id="c-randomdata__open" class="c-randomdata__toggle" style="display: none"><i class="fa fa-wrench"></i></span>
// 			<span id="c-randomdata__close" class="c-randomdata__toggle">close</span>
// 			<div id="c-randomdata__refresh" style="display: none">
// 				<i class="fa fa-play-circle" style="display: block; color: black"></i>
// 			</div>
// 		</div>
// 		<div id="c-randomdata__container" style="padding: 1em; font-family: monospace;">
// 			<div>
// 				<p>Adds Random event data to any class name js__title</p>
// 				<input type="checkbox" name="vehicle1" value="Hippodrome"> Birmingham Hippodrome<br>
// 				<input type="checkbox" name="vehicle2" value="AmRep" disabled> American Repetory Theatre<br>
// 				<input type="checkbox" name="vehicle3" value="Boat" disabled> Third Customer<br>
// 			</div>
